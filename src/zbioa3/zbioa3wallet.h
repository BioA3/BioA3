...
#ifndef BIOA3_ZBIOA3WALLET_H
#define BIOA3_ZBIOA3WALLET_H
...
public:
    CzBIOA3Wallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZBIOA3(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZBIOA3(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
