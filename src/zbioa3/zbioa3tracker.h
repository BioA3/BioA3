...
#ifndef BIOA3_ZBIOA3TRACKER_H
#define BIOA3_ZBIOA3TRACKER_H
...
public:
    CzBIOA3Tracker(std::string strWalletFile);
    ~CzBIOA3Tracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzBIOA3Wallet* zBIOA3Wallet = NULL);
