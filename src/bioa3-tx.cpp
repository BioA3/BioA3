...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BioA3 Core bioa3-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bioa3-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bioa3 transaction") + "\n" +
                               "  bioa3-tx [options] -create [commands]   " + _("Create hex-encoded bioa3 transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bioa3 transaction
