...
#include "qt/bioa3/coincontrolbioa3widget.h"
#include "qt/bioa3/forms/ui_coincontrolbioa3widget.h"

CoinControlBioA3Widget::CoinControlBioA3Widget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlBioA3Widget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select BIOA3 Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("BIOA3");
    ...
    ui->labelValueAfter->setText("0.00 BIOA3");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 BIOA3");
    ui->labelValueFee->setText("0.00 BIOA3");
...
CoinControlBioA3Widget::~CoinControlBioA3Widget()
{
    delete ui;
}
