...
#ifndef BIOA3_CORE_NEW_GUI_BIOA3GUI_H
#define BIOA3_CORE_NEW_GUI_BIOA3GUI_H
...
/**
  BIOA3 GUI main class. This class represents the main window of the BIOA3 UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class BIOA3GUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit BIOA3GUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~BIOA3GUI();
...
#endif //BIOA3_CORE_NEW_GUI_BIOA3GUI_H
