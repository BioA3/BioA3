...
#include "qt/bioa3/topbar.h"
#include "qt/bioa3/forms/ui_topbar.h"
#include <QPixmap>
#include "qt/bioa3/lockunlock.h"
#include "qt/bioa3/qtutils.h"
#include "qt/bioa3/receivedialog.h"
...
TopBar::TopBar(BIOA3GUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopBioA3, ui->labelAmountTopzBioA3}, "amount-small-topbar");
    setCssProperty({ui->labelAmountBioA3, ui->labelAmountzBioA3}, "amount-topbar");
    setCssProperty({ui->labelPendingBioA3, ui->labelPendingzBioA3, ui->labelImmatureBioA3, ui->labelImmaturezBioA3}, "amount-small-topbar");

    ui->labelAmountTopzBioA3->setVisible(false);
    ui->label_16->setVisible(false);
    ui->labelTitle2->setVisible(false);
    ui->labelAmountzBioA3->setVisible(false);
    ui->labelTitle5->setVisible(false);
    ui->labelPendingzBioA3->setVisible(false);
    ui->labelTitle6->setVisible(false);
    ui->labelImmaturezBioA3->setVisible(false);
...
void TopBar::updateBalances(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance,
    ...
    // BIOA3 Total
    CAmount bioa3AvailableBalance = balance;
    // zBIOA3 Balance
    CAmount matureZerocoinBalance = zerocoinBalance - unconfirmedZerocoinBalance - immatureZerocoinBalance;

    // Set
    QString totalBioA3 = GUIUtil::formatBalance(bioa3AvailableBalance, nDisplayUnit);
    QString totalzBioA3 = GUIUtil::formatBalance(matureZerocoinBalance, nDisplayUnit, true);
    // Top
    ui->labelAmountTopBioA3->setText(totalBioA3);
    ui->labelAmountTopzBioA3->setText(totalzBioA3);

    // Expanded
    ui->labelAmountBioA3->setText(totalBioA3);
    ui->labelAmountzBioA3->setText(totalzBioA3);

    ui->labelPendingBioA3->setText(GUIUtil::formatBalance(unconfirmedBalance, nDisplayUnit));
    ui->labelPendingzBioA3->setText(GUIUtil::formatBalance(unconfirmedZerocoinBalance, nDisplayUnit, true));

    ui->labelImmatureBioA3->setText(GUIUtil::formatBalance(immatureBalance, nDisplayUnit));
    ui->labelImmaturezBioA3->setText(GUIUtil::formatBalance(immatureZerocoinBalance, nDisplayUnit, true));
}
