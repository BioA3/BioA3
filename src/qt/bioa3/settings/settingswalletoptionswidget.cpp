...
#include "qt/bioa3/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/bioa3/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(BIOA3GUI* _window, QWidget *parent) :
