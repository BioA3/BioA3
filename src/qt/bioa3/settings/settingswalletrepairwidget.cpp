...
#include "qt/bioa3/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/bioa3/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(BIOA3GUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to BIOA3GUI::handleRestart()
