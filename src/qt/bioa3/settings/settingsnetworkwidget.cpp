...
#include "qt/bioa3/settings/settingsnetworkwidget.h"
#include "qt/bioa3/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/bioa3/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(BIOA3GUI* _window, QWidget *parent) :
