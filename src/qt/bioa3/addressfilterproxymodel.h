...
#ifndef BIOA3_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define BIOA3_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //BIOA3_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
