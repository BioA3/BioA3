...
#include "config/bioa3-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qreal maxValue = 0;
    qint64 totalBioA3 = 0;
    qint64 totalZbioa3 = 0;
    QList<qreal> valuesBioA3;
    QList<qreal> valueszBioA3;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(BIOA3GUI* _window);
    ~DashboardWidget();
