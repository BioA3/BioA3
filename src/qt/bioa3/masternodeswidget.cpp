...
#include "qt/bioa3/forms/ui_masternodeswidget.h"
#include "qt/bioa3/qtutils.h"
#include "qt/bioa3/mnrow.h"
#include "qt/bioa3/mninfodialog.h"

#include "qt/bioa3/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(BIOA3GUI *parent) :
    PWidget(parent),
    ...
    if (boost::filesystem::exists(pathBootstrap)) {
        ...
        if (lineCopy.size() == 0) {
            lineCopy = "# Masternode config file\n"
                                    ...
                                    "# Example: mn1 127.0.0.2:41372 93HaYBVUCYjEMeeH1Y4sBGLALQZE1Yc1K64xiqgX37tGBDQL8Xg 2bcd3c84c84f87eaa86e4e56834c92927a07f9e18718810b92e0d0324456a67c 0\n";
        }
...
void MasterNodesWidget::onCreateMNClicked(){
    if(verifyWalletUnlocked()) {
        if(walletModel->getBalance() <= (COIN * 100000)){
            inform(tr("Not enough balance to create a masternode, 100,000 BIOA3 required."));
            return;
        }
        showHideOp(true);
