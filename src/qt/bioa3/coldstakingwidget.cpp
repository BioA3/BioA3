...
#include "qt/bioa3/coldstakingwidget.h"
#include "qt/bioa3/forms/ui_coldstakingwidget.h"
#include "qt/bioa3/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/bioa3/requestdialog.h"
#include "qt/bioa3/tooltipmenu.h"
#include "qt/bioa3/furlistrow.h"
...
ColdStakingWidget::ColdStakingWidget(BIOA3GUI* parent) :
    PWidget(parent),
    ...
    isLoading(false)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your BIOA3s, letting a hot node (24/7 online node)\nstake on your behalf, while you keep the keys securely offline."));
    ...
    ui->labelSubtitle2->setText(tr("Accept BIOA3 delegation / Delegate BIOA3"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select BIOA3 outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 BIOA3" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
