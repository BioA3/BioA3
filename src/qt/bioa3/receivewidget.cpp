...
#include "qt/bioa3/forms/ui_receivewidget.h"
...
#include "qt/bioa3/addressholder.h"
...
ReceiveWidget::ReceiveWidget(BIOA3GUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive BIOA3."));
