...
#include "qt/bioa3/forms/ui_masternodewizarddialog.h"
    ...
    walletModel(model)
{
    ...
    ui->lineEditPort->setPlaceholderText("e.g 41372");
    ...
    if(walletModel->isTestNetwork()){
        ...
        ui->lineEditPort->setText("41374");
    } else {
        ui->lineEditPort->setText("41372");
    }
