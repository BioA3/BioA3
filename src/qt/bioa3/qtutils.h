...
bool openDialogWithOpaqueBackgroundY(QDialog *widget, BIOA3GUI *gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog *widget, BIOA3GUI *gui, double posX = 3);
