...
/** Utility functions used by the BIOA3 Qt UI.
 */
namespace GUIUtil
{
...
// Render BIOA3 addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZbioa3 = false);
...
// Parse "bioa3:" URI into recipient object, return true on successful parsing
