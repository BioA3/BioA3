...
/* BioA3 GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "BIOA3"
#define QAPP_ORG_DOMAIN "bioa3.org"
#define QAPP_APP_NAME_DEFAULT "BIOA3-Qt"
#define QAPP_APP_NAME_TESTNET "BIOA3-Qt-testnet"
