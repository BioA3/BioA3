...
"""Verify that starting bioa3 with -h works as expected."""
import subprocess

from test_framework.test_framework import BioA3TestFramework
from test_framework.util import assert_equal

class HelpTest(BioA3TestFramework):
    ...
    def run_test(self):
        self.log.info("Start bioa3 with -h for help text")
        ...
        self.log.info("Start bioa3 with -version for version information")
