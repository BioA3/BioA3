...
class BudgetProposalTest(BioA3TestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Test with invalid BIOA3 address")
        assert_raises_rpc_error(-5, "Invalid BIOA3 address", self.nodes[0].preparebudget,
        ...
        assert_raises_rpc_error(-8, "Invalid amount - Payment of 9.00 is less than minimum 10 BIOA3 allowed", self.nodes[0].preparebudget,
