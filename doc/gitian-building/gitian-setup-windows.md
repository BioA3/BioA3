...
The build script we'll be using is contained in the BIOA3 github repository ([contrib/gitian-build.py](https://github.com/bioa3/bioa3/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the BIOA3 repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/BIOA3-Project/BIOA3/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, bioa3-detached-sigs, and bioa3 GitHub repos.
